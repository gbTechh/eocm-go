...
func (h *Handler) Create(c echo.Context) error {
	...
	return c.JSON(http.StatusCreated, 
			response.Success("Categoría de impuesto creada exitosamente", category))
}
...
func (h *Handler) GetByID(c echo.Context) error {
	...
	return c.JSON(http.StatusOK, 
			response.Success("Categoría de impuesto  obtenida exitosamente", category))
}
...
func (h *Handler) Update(c echo.Context) error {
	...
	return c.JSON(http.StatusOK, 
			response.Success("Categoría de impuesto actualizada exitosamente", category))
}
...
func (h *Handler) Delete(c echo.Context) error {
	...
	return c.JSON(http.StatusOK, 
			response.Success("Categoría de impuesto eliminada exitosamente", nil))
}
	...
	default:
			if errors.IsNotFound(err) {
					return c.JSON(http.StatusNotFound, 
							response.Error("Categoría de impuesto no encontrado", nil))
			}
