...
func (h *Handler) Create(c echo.Context) error {
	...
	return c.JSON(http.StatusCreated, 
			response.Success("Tasa de impuesto creada exitosamente", tz))
}
...
func (h *Handler) GetByID(c echo.Context) error {
	...
	return c.JSON(http.StatusOK, 
			response.Success("Tasa de impuesto actualizada exitosamente", tz))
}
...
func (h *Handler) Delete(c echo.Context) error {
	...
	return c.JSON(http.StatusOK, 
			response.Success("Tasa de impuesto eliminada exitosamente", nil))
}
...
func (h *Handler) List(c echo.Context) error {
	...
	return c.JSON(http.StatusOK, 
        response.Success("Tasas de impuesto obtenidas exitosamente", 
	...
	default:
		if errors.IsNotFound(err) {
				return c.JSON(http.StatusNotFound, 
						response.Error("Tasa de impuesto no encontrado", nil))
		}
