...
func (h *Handler) Create(c echo.Context) error {
	...
	return c.JSON(http.StatusCreated, 
			response.Success("Impuesto de zona creada exitosamente", tz))
}
...
func (h *Handler) GetByID(c echo.Context) error {
	...
	return c.JSON(http.StatusOK, 
			response.Success("Impuesto de zona obtenida exitosamente", tz))
}
...
func (h *Handler) Update(c echo.Context) error {
	...
	return c.JSON(http.StatusOK, 
			response.Success("Impuesto de zona actualizada exitosamente", tz))
}
...
func (h *Handler) Delete(c echo.Context) error {
	...
	return c.JSON(http.StatusOK, 
			response.Success("Impuesto de zona eliminada exitosamente", nil))
}
...
func (h *Handler) List(c echo.Context) error {
	...
	return c.JSON(http.StatusOK, 
			response.Success("Categorías de impuesto obtenidas exitosamente", 
	...
	default:
			if errors.IsNotFound(err) {
					return c.JSON(http.StatusNotFound, 
							response.Error("Impuesto de zona no encontrado", nil))
			}
